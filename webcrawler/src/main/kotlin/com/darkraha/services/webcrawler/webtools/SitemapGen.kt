...
class SitemapGen : Plugin<CrawlingResult> {
    ...
    private var date: String = Helper.w3cDateTimeFormat.format(Date())
    ...
    override fun attachTo(builderTask: DeferredUserBuilder<CrawlingResult>): DeferredUserBuilder<CrawlingResult> =
        builderTask
    ...
    private val onFinish = Consumer<JobResponse<CrawlingResult>> {
        sb.append("</urlset>")
    }

    private val onStart = Consumer<JobResponse<CrawlingResult>> {
    ...
    class Builder {
        ...
        fun customDate(v: Boolean) =
            this.apply { sitemapGen.isCustomDate = v; sitemapGen.date = Helper.w3cDateTimeFormat.format(Date()) }

        fun customDate(d: Date) =
            this.apply { sitemapGen.isCustomDate = true; sitemapGen.date = Helper.w3cDateTimeFormat.format(d) }
