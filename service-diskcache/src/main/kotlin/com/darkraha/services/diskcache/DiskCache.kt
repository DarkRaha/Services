...
interface DiskCache {
     ...
     */
    fun addFile(key: String, file: File, isPersistent: Boolean = false): UserDeferred<Unit>
    fun addFileOrUpdate(key: String, file: File, isPersistent: Boolean = false): UserDeferred<Unit>

    /**
     * Remove files by key from diskcache storage.
     */
    fun removeKey(key: String, isPersistent: Boolean = false): UserDeferred<Unit>
     ...
     * Get file by its key.
     */
    fun getFile(key: String, modification: String? = null): File?

    /**
     * Allows to get file when a file extension is known. More fast then getFile method.
     */
    fun getFileExt(key: String, fileExtension: String? = null, modification: String? = null): File?
